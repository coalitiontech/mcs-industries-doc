...
![brand-marketting-banner-add-image-list.png](img/brand-marketting-banner-add-image-list.png)

![brand-marketting-banner-insert-image-list.png](img/brand-marketting-banner-insert-image-list.png)

Once the image is visible in the content area, press enter to ensure the cursor is where is show in the below image:

![brand-marketting-banner-insert-page-break-list.png](img/brand-marketting-banner-insert-page-break-list.png)

![brand-marketting-banner-insert-page-break-2-list.png](img/brand-marketting-banner-insert-page-break-2-list.png)
...
![brand-marketting-banner-images-list.jpeg](img/brand-marketting-banner-images-list.jpeg)

The rest of the options on the page can be selected as follow, please make sure the location is set to one of the brands:

![brand-marketting-banner-rest-of-the-options-list.jpeg](img/brand-marketting-banner-rest-of-the-options-list.jpeg)
