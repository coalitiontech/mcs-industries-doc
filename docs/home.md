...
![header-content.png](img/header-content.png)
...
![edit-brand-bc.png](img/edit-brand-bc.png)
...
![reviews-content-bc.png](img/reviews-content-bc.png)
...
![affiliations-content-bc.png](img/affiliations-content-bc.png)

Additional settings to change title and subtitle:

![affiliations-additional-options.png](img/affiliations-additional-options.png)
...
![blogs-bc.png](img/blogs-bc.png)

![blog-edit-bc.png](img/blog-edit-bc.png)

One of the options allows to add an image to the blog, note only the blogs having images are displayed:

![blog-image-edit-bc.png](img/blog-image-edit-bc.png)
